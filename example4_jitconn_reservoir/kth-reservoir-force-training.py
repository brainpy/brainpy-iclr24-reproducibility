...
python kth-reservoir-force-training.py -comp_type dense -num_hidden 10000 -win_connectivity 0.01 -wrec_connectivity 0.001 -train_start 10 -gpu-id 2
python kth-reservoir-force-training.py -comp_type jit-v1 -num_hidden 10000 -win_connectivity 0.01 -wrec_connectivity 0.001 -train_start 10 -gpu-id 1


  Test, frame accuracy 0.9130654111316631, stream accuracy 0.9266666666666666

num_hidden 10000, win_connectivity 0.1, wrec_connectivity 0.01 -train_start 10

  Test, frame accuracy 0.8967546662182613, stream accuracy 0.92
...
if socket.gethostname() in ['ai01', 'login01']:
  ...
  path = '/mnt/d/data/kth_hog8x8_pca2k_labels.mat'
...
def get_data_v2():
  ...
  # xs_t1 = np.concatenate(xs_t1, axis=1).T
  # ys_t1 = np.concatenate(ys_t1) - 1
  # resets_t1 = np.concatenate(resets_t1)
  # trains_t1 = np.concatenate(trains_t1)

  xs_t2 = [x.transpose() for x in xs_t2]
  # xs_t2 = np.concatenate(xs_t2, axis=1).T
  # ys_t2 = np.concatenate(ys_t2) - 1
  # resets_t2 = np.concatenate(resets_t2)
  # trains_t2 = np.concatenate(trains_t2)
