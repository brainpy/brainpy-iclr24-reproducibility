# -*- coding: utf-8 -*-
'''
BrainPy single epoch: ~50 s
BrainPy max test accuracy: 93.54%
SpikingJelly single epoch: ~104 s
SpikingJelly max test accuracy: 93.3%
'''
...
def classify_cifar():
  ...
  for epoch in range(start_epoch, args.epochs):
    ...
    train_acc = 0
    train_samples = 0
    pbar = tqdm.tqdm(total=len(train_data_loader))
    ...
    test_acc = 0
    test_samples = 0
    pbar = tqdm.tqdm(total=len(test_data_loader))
